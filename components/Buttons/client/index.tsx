    ...
    <AlertDialog open={isDialogOpen}>
      <AlertDialogTrigger onClick={handleOpenDialog} asChild>
        <button
          type="button"
          className={
            `cursor-pointer p-1 rounded transition-all border border-transparent outline-none focus-visible:ring-[3px] focus-visible:ring-neutral-500 focus-visible:bg-neutral-800 ` // focus-visible:[&_*]:stroke-theme-color hover:[&_*]:stroke-theme-color
          }
        >
