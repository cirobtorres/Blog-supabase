  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          `z-50 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md p-1 shadow-md ` +
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        `relative flex items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden cursor-default select-none ` +
          `data-[inset]:pl-8 ` +
          ...
          `focus:bg-neutral-800 focus:text-neutral-200 `,
        className
      )}
      {...props}
    />
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        `relative flex items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden cursor-default select-none ` +
          `data-[disabled]:pointer-events-none data-[disabled]:opacity-50 ` +
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        `flex items-center rounded-sm px-2 py-1.5 text-sm outline-hidden cursor-default select-none` +
          `data-[inset]:pl-8 ` +
          `data-[state=open]:bg-neutral-800 data-[state=open]:text-neutral-200 ` +
          `focus:bg-neutral-800 focus:text-neutral-200 `,
        className
      )}
      {...props}
