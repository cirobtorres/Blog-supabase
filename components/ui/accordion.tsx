  ...
  return (
    <AccordionPrimitive.Header className="flex pb-0!">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-start justify-between gap-4 rounded-md py-4 text-left text-sm transition-all outline-none disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:rotate-180",
