...
const TextEditorIcon = ({
  ...
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-case-upper-icon lucide-case-upper ${color ?? ""}`}
  >
...
const CodeEditorIcon = ({
  ...
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-code-xml-icon lucide-code-xml ${color ?? ""}`}
  >
...
const QuoteEditorIcon = ({
  ...
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-quote-icon lucide-quote ${color ?? ""}`}
  >
...
const ImageEditorIcon = ({
  ...
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-image-icon lucide-image ${color ?? ""}`}
  >
...
const ImageCarouselEditorIcon = ({
  ...
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    className={`lucide lucide-images-icon lucide-images ${color ?? ""}`}
  >
...
const PlusIcon = ({ color, size = 24, className, ...props }: PlusIconProps) => (
  <svg
    {...props}
    xmlns="http://www.w3.org/2000/svg"
    width={size}
